...
describe WatchlistsController do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved watchlist as @watchlist" do
        ...
        Watchlist.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested watchlist" do
        watchlist = Watchlist.create! valid_attributes
        # Assuming there are no other watchlists in the database, this
        # specifies that the Watchlist created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Watchlist.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => watchlist.id, :watchlist => {'these' => 'params'}
      end
    ...
    describe "with invalid params" do
      it "assigns the watchlist as @watchlist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Watchlist.any_instance.stub(:save).and_return(false)
        put :update, :id => watchlist.id, :watchlist => {}
        assigns(:watchlist).should eq(watchlist)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested watchlist" do
      watchlist = Watchlist.create! valid_attributes
      expect {
        delete :destroy, :id => watchlist.id
      }.to change(Watchlist, :count).by(-1)
    end
